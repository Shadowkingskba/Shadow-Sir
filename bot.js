...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______ 𝐒𝐇𝐀𝐃𝐎𝐖-𝐒𝐈𝐑 _____🕊️♥️~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCgAYi3VlqblK72qFAjW14cQ'
                                    , MessageType.text);
                            }
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [♥️🕊️______ 𝐒𝐇𝐀𝐃𝐎𝐖-𝐒𝐈𝐑 _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCgAYi3VlqblK72qFAjW14cQ' +
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [♥️🕊️______ 𝐒𝐇𝐀𝐃𝐎𝐖-𝐒𝐈𝐑 _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                        '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCgAYi3VlqblK72qFAjW14cQ' +
